    ...
    <div class="container pt-5">
        <div class="row">
                    ...
                    <div class="row   mb-5">
                        <div class="col-12">
                            ...
                            <div class="dropdown float-right">
                                <a class="btn btn-lg btn-light dropdown-toggle products-actual-count" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">9<span class="caret"></span></a>
            ...
            <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
                ...
                <div class="divider mt-5 mb-5 border-bottom border-secondary"></div>
                <a href="#" class="btn btn-lg btn-block btn-primary mt-5" id="filter-button">{{ __('shop.welcome.filter') }}&emsp; <i class="fa-solid fa-magnifying-glass"></i></a>
            </form>
        </div>
    </div>
@endsection
