                        ...
                        <div class="cart_container">
                                ...
                                <ul class="cart_list">
                                    @foreach($cart->getItems() as $item)
                                        <li class="row text-center justify-content-center cart_item clearfix align-items-center">
                                            ...
                                            <div class="col-md-3">
                                                <div class="cart_item_title">{{ __('shop.product.fields.name')}}</div>
                                                <div class="cart_item_text">{{ $item->getName(); }}</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="cart_item_title">{{ __('shop.product.fields.amount')}}</div>
                                                <div class="cart_item_text">{{ $item->getQuantity(); }}</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="cart_item_title">{{ __('shop.product.fields.price')}}</div>
                                                <div class="cart_item_text">{{ $item->getPrice(); }}</div>
                                            </div>
                                            <div class="col-md-2">
                                                <div class="cart_item_title">{{ __('shop.product.fields.total')}}</div>
                            ...
                            <div class="order_total">
                                <div class="order_total_content text-md-right">
                                    <div class="order_total_title">{{ __('shop.product.fields.total')}}:</div>
